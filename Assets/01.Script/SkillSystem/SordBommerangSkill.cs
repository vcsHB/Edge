...
{
//    주 무기로 사용하는 검을 마우스의 방향으로 던진다.검은 부메랑처럼 회전하며 발사(애니메이션으로 검이 회전하는거 만들고,
//    오브젝트를 2차함수의 y값 변화량 느낌으로 던진다.), 
//    마우스의 방향으로 날아갔다가 돌아온다.(0.5초동안 날아갔다가 0.5초동안 돌아옴)(이것 역시도 Ease가 필요함. 2차함수 참고..)
